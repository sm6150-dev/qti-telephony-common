...
public final class CdmaInformationRecord {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size3; _hidl_index_04++) {
            ((CdmaSignalInfoRecord) this.signal.get(_hidl_index_04)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_04 * 4));
        }
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size4; _hidl_index_05++) {
            ((CdmaRedirectingNumberInfoRecord) this.redir.get(_hidl_index_05)).writeEmbeddedToBlob(childBlob4, (long) (_hidl_index_05 * 32));
        }
        ...
        for (int _hidl_index_06 = 0; _hidl_index_06 < _hidl_vec_size5; _hidl_index_06++) {
            ((CdmaLineControlInfoRecord) this.lineCtrl.get(_hidl_index_06)).writeEmbeddedToBlob(childBlob5, (long) (_hidl_index_06 * 4));
        }
        ...
        for (int _hidl_index_07 = 0; _hidl_index_07 < _hidl_vec_size6; _hidl_index_07++) {
            ((CdmaT53ClirInfoRecord) this.clir.get(_hidl_index_07)).writeEmbeddedToBlob(childBlob6, (long) (_hidl_index_07 * 1));
        }
        ...
        while (true) {
            ...
            if (_hidl_index_08 < _hidl_vec_size7) {
                ((CdmaT53AudioControlInfoRecord) this.audioCtrl.get(_hidl_index_08)).writeEmbeddedToBlob(childBlob7, (long) (_hidl_index_08 * 2));
                _hidl_index_0 = _hidl_index_08 + 1;
            } else {
