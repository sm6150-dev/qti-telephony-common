...
public class QtiPrimaryCardPriorityHandler {
    ...
    public int[] getNwModesFromConfig(int primarySlotId) {
        ...
        for (int i2 = 0; i2 < QtiPrimaryCardUtils.PHONE_COUNT; i2++) {
            if (this.mCurrPriorityConfigs[i2] != null) {
                if (i2 == primarySlotId) {
                    i = this.mCurrPriorityConfigs[i2].network1;
                } else {
                    i = this.mCurrPriorityConfigs[i2].network2;
                }
                prefNwModes[i2] = i;
            } else {
    ...
    private PriorityConfig getPriorityConfig(int slotId) {
        ...
        if (cardInfo.getIccId() == null) {
            StringBuilder sb = new StringBuilder();
            sb.append("getPriorityConfig: for slot:");
            sb.append(slotId);
        ...
        sb2.append("getPriorityConfig: for slot:");
        sb2.append(slotId);
        sb2.append(" mcc-mnc ");
                ...
                switch (priorityConfigComparator) {
                    case 1:
                        if (pConfig.pattern.matcher(cardInfo.getIccId()).find() && cardInfo.isCardTypeSame(pConfig.cardType)) {
                            ...
                            sb3.append("getPriorityConfig: Found for slot:");
                            sb3.append(slotId);
                            sb3.append(", ");
                            sb3.append(pConfig);
                            logd(sb3.toString());
                    ...
                    case 2:
                        if (!cardInfo.isCardTypeSame(pConfig.cardType)) {
                            ...
                            sb4.append("getPriorityConfig: Found for slot:");
                            sb4.append(slotId);
                            sb4.append(", ");
                            sb4.append(pConfig);
                            logd(sb4.toString());
                    ...
                    case 3:
                        if (cardInfo.getMccMnc() != null && pConfig.pattern.matcher(cardInfo.getMccMnc()).find() && cardInfo.isCardTypeSame(pConfig.cardType)) {
                            ...
                            sb5.append("getPriorityConfig: Found for slot:");
                            sb5.append(slotId);
                            sb5.append(", ");
                            sb5.append(pConfig);
                            loge(sb5.toString());
    ...
    private void readPriorityConfigFromXml() {
        ...
        try {
            ...
            Rlog.e(str, sb2.toString(), e);
            this.mLoadingConfigCompleted = VDBG;
            StringBuilder sb3 = new StringBuilder();
            sb3.append("mAllPriorityConfigs: ");
            ...
            StringBuilder sb4 = new StringBuilder();
            sb4.append("mAllPriorityConfigs: ");
