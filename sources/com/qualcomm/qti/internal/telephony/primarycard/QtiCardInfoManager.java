...
public class QtiCardInfoManager extends Handler {
    ...
    /* access modifiers changed from: private */
    public CardInfo[] mCardInfos = new CardInfo[PHONE_COUNT];
    ...
    public static class CardInfo {
        ...
        public boolean isCardInfoAvailable(int slotId) {
            boolean isAvailable = (this.mUpdateCardTypeState == 0 || this.mUpdateCardTypeState == 1) ? QtiCardInfoManager.VDBG : true;
