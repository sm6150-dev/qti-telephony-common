...
public class QtiRadioCapabilityController extends Handler {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            String str = QtiRadioCapabilityController.LOG_TAG;
    ...
    private void handleUpdateBindingDone(int result) {
        ...
        notifyRadioCapsUpdated(result == 1);
        while (true) {
            int i4 = errorCode;
            if (i4 < mNumPhones) {
                int errorCode2 = 0;
                ...
                if (resp != null) {
                    ...
                    sendResponseToTarget(resp, errorCode2);
    ...
    private synchronized boolean updateStackBindingIfRequired(boolean r11) {
        ...
        L_0x0037:
            ...
            com.qualcomm.qti.internal.telephony.QtiSubscriptionController r8 = r10.mQtiSubscriptionController     // Catch:{ all -> 0x0148 }
            r9 = r7[r5]     // Catch:{ all -> 0x0148 }
            boolean r8 = r8.isActiveSubId(r9)     // Catch:{ all -> 0x0148 }
            if (r8 != 0) goto L_0x006c
        L_0x0056:
    ...
    private int getNetworkModeFromDB(int phoneId) {
        ...
        StringBuilder sb3 = new StringBuilder();
        sb3.append("preferred_network_mode");
        sb3.append(subId[0]);
        ...
        for (int i = 0; i < mNumPhones; i++) {
            ...
            if (this.mPrefNwMode[i] != nwModeFromDB) {
                ...
                if (this.mQtiSubscriptionController.isActiveSubId(subId[0])) {
                    ContentResolver contentResolver = this.mContext.getContentResolver();
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("preferred_network_mode");
                    sb2.append(subId[0]);
    ...
    public synchronized void setPreferredNetworkType(int r6, int r7, android.os.Message r8) {
        ...
        L_0x000f:
            ...
            com.qualcomm.qti.internal.telephony.QtiSubscriptionController r3 = r5.mQtiSubscriptionController     // Catch:{ all -> 0x00d2 }
            r4 = r0[r2]     // Catch:{ all -> 0x00d2 }
            boolean r3 = r3.isActiveSubId(r4)     // Catch:{ all -> 0x00d2 }
            r1 = r3
        L_0x0025:
    ...
    private void sendSubscriptionSettings(int phoneId) {
        ...
        int[] subId = this.mQtiSubscriptionController.getSubId(phoneId);
        if (subId != null && subId.length > 0 && this.mQtiSubscriptionController.isActiveSubId(subId[0])) {
            phone.mDcTracker.setUserDataEnabled(phone.mDcTracker.isUserDataEnabled());
        }
    }
    ...
    public boolean initNormalMappingRequest() {
        ...
        while (i < mNumPhones) {
            ...
            RadioCapability rc = new RadioCapability(i, 0, 0, i == 0 ? minRaf : maxRaf, i == 0 ? "1" : "0", 1);
            this.mPhone[i].radioCapabilityUpdated(rc);
            i++;
        }
        RadioAccessFamily[] rafs = new RadioAccessFamily[mNumPhones];
        int i2 = 0;
        while (i2 < mNumPhones) {
            rafs[i2] = new RadioAccessFamily(i2, i2 == 0 ? maxRaf : minRaf);
            i2++;
        }
        ...
        for (int i3 = 0; i3 < mNumPhones; i3++) {
            this.mPhone[i3].radioCapabilityUpdated(oldRadioCapability[i3]);
        }
