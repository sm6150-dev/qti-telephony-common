...
public final class SignalStrength {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.rsrp == other.rsrp && this.snr == other.snr) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.rsrp))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.snr)))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.rsrp = _hidl_blob.getInt32(0 + _hidl_offset);
        this.snr = _hidl_blob.getInt32(4 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SignalStrength> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((SignalStrength) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt32(0 + _hidl_offset, this.rsrp);
        _hidl_blob.putInt32(4 + _hidl_offset, this.snr);
    }
}
