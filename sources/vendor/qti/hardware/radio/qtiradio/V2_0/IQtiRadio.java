...
public interface IQtiRadio extends vendor.qti.hardware.radio.qtiradio.V1_0.IQtiRadio {
    public static final String kInterfaceName = "vendor.qti.hardware.radio.qtiradio@2.0::IQtiRadio";
    ...
    public static final class Proxy implements IQtiRadio {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.radio.qtiradio@2.0::IQtiRadio]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IQtiRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IQtiRadio.kInterfaceName, vendor.qti.hardware.radio.qtiradio.V1_0.IQtiRadio.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-40, -95, -82, 7, 54, 109, -100, 20, 14, -10, -16, -62, 74, -70, 70, -42, -28, -56, 68, -44, 52, -60, 32, 26, -29, -57, 67, 66, -53, 121, -113, -98}, new byte[]{104, 5, 119, -96, 97, 84, -113, 29, -121, 85, -57, -4, 82, -81, 82, 98, 56, 40, 124, -97, 24, 39, -79, 32, 16, -100, -9, 15, -67, -59, 109, -36}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            String str = vendor.qti.hardware.radio.qtiradio.V1_0.IQtiRadio.kInterfaceName;
            String str2 = IQtiRadio.kInterfaceName;
            boolean z = false;
            boolean z2 = true;
            switch (_hidl_code) {
                case 1:
    ...
    void disable5g(int i) throws RemoteException;

    void enable5g(int i) throws RemoteException;

    void enable5gOnly(int i) throws RemoteException;
    ...
    void query5gStatus(int i) throws RemoteException;

    void queryNrBearerAllocation(int i) throws RemoteException;

    void queryNrDcParam(int i) throws RemoteException;

    void queryNrSignalStrength(int i) throws RemoteException;

    void sendCdmaSms(int i, CdmaSmsMessage cdmaSmsMessage, boolean z) throws RemoteException;
