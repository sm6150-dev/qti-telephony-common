...
public interface IQtiRadioIndication extends vendor.qti.hardware.radio.qtiradio.V1_0.IQtiRadioIndication {
    public static final String kInterfaceName = "vendor.qti.hardware.radio.qtiradio@2.0::IQtiRadioIndication";
    ...
    public static final class Proxy implements IQtiRadioIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.radio.qtiradio@2.0::IQtiRadioIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IQtiRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IQtiRadioIndication.kInterfaceName, vendor.qti.hardware.radio.qtiradio.V1_0.IQtiRadioIndication.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{0, -106, 44, 30, -44, 73, -45, 31, 95, 73, 23, 53, 77, -105, 17, 20, 43, 103, 19, 16, 61, -97, 40, 42, -36, 74, 37, 65, -46, 1, -5, -21}, new byte[]{71, 94, -111, 68, -72, 64, 77, -22, 52, 81, 106, 67, 106, 2, -68, 121, -45, -28, 12, -103, 12, 65, -42, 91, -93, 78, 124, -73, 46, -62, 73, 106}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}}));
        }
