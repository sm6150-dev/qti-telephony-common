...
public interface IQtiRadioResponse extends vendor.qti.hardware.radio.qtiradio.V2_2.IQtiRadioResponse {
    public static final String kInterfaceName = "vendor.qti.hardware.radio.qtiradio@2.3::IQtiRadioResponse";
    ...
    public static final class Proxy implements IQtiRadioResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.radio.qtiradio@2.3::IQtiRadioResponse]@Proxy";
            }
        }
        ...
        public void onNrIconTypeResponse(int serial, int errorCode, int iconType) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.radio.qtiradio.V2_2.IQtiRadioResponse.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(errorCode);
        ...
        public void onEnableEndcResponse(int serial, int errorCode, int status) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        public void onEndcStatusResponse(int serial, int errorCode, int endcStatus) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IQtiRadioResponse.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(errorCode);
            _hidl_request.writeInt32(endcStatus);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IQtiRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IQtiRadioResponse.kInterfaceName, vendor.qti.hardware.radio.qtiradio.V2_2.IQtiRadioResponse.kInterfaceName, vendor.qti.hardware.radio.qtiradio.V2_1.IQtiRadioResponse.kInterfaceName, vendor.qti.hardware.radio.qtiradio.V2_0.IQtiRadioResponse.kInterfaceName, vendor.qti.hardware.radio.qtiradio.V1_0.IQtiRadioResponse.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            String str2 = vendor.qti.hardware.radio.qtiradio.V2_1.IQtiRadioResponse.kInterfaceName;
            String str3 = vendor.qti.hardware.radio.qtiradio.V2_0.IQtiRadioResponse.kInterfaceName;
            boolean z = false;
            boolean z2 = true;
            switch (_hidl_code) {
                case 1:
                ...
                case 13:
                    ...
                    _hidl_request.enforceInterface(vendor.qti.hardware.radio.qtiradio.V2_2.IQtiRadioResponse.kInterfaceName);
                ...
                case 14:
                    ...
                    onEnableEndcResponse(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 15:
                    if (_hidl_flags != false && true) {
                        z = true;
                    ...
                    _hidl_request.enforceInterface(str);
                    onEndcStatusResponse(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                default:
