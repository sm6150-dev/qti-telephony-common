...
public interface IQtiRadioResponse extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IQtiRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IQtiRadioResponse.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{91, 97, -35, -102, -53, 116, 101, 77, -43, 32, 62, -35, -6, -77, -114, 91, -62, -41, -89, -82, 100, 120, -108, 84, 1, -15, 71, -27, 111, -126, 116, -71}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
