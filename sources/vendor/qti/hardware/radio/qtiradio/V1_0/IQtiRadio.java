...
public interface IQtiRadio extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IQtiRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IQtiRadio.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{104, 5, 119, -96, 97, 84, -113, 29, -121, 85, -57, -4, 82, -81, 82, 98, 56, 40, 124, -97, 24, 39, -79, 32, 16, -100, -9, 15, -67, -59, 109, -36}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
